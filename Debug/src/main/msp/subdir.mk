...
C_DEPS += \
./src/main/msp/msp.d \
./src/main/msp/msp_box.d 


# Each subdirectory must supply rules for building sources it contributes
src/main/msp/%.o src/main/msp/%.su src/main/msp/%.cyclo: ../src/main/msp/%.c src/main/msp/subdir.mk
...
clean: clean-src-2f-main-2f-msp

clean-src-2f-main-2f-msp:
	-$(RM) ./src/main/msp/msp.cyclo ./src/main/msp/msp.d ./src/main/msp/msp.o ./src/main/msp/msp.su ./src/main/msp/msp_box.cyclo ./src/main/msp/msp_box.d ./src/main/msp/msp_box.o ./src/main/msp/msp_box.su

.PHONY: clean-src-2f-main-2f-msp
