...
src/main/rx/%.o src/main/rx/%.su src/main/rx/%.cyclo: ../src/main/rx/%.c src/main/rx/subdir.mk
...
clean: clean-src-2f-main-2f-rx

clean-src-2f-main-2f-rx:
	-$(RM) ./src/main/rx/crsf.cyclo ./src/main/rx/crsf.d ./src/main/rx/crsf.o ./src/main/rx/crsf.su ./src/main/rx/rx.cyclo ./src/main/rx/rx.d ./src/main/rx/rx.o ./src/main/rx/rx.su

.PHONY: clean-src-2f-main-2f-rx
